...
public class OAuth2Config {
    ...
    public AuthenticationSuccessHandler oAuth2SuccessHandler() {
        return (request, response, authentication) -> {
            ...
            // 1. Pega os dados do usuário (sem alteração)
            ...
            // 2. Processa o login (sem alteração)
            ...
            // 3. Constrói a URL de redirecionamento com AMBOS os parâmetros
            // Esta é a forma correta e segura de adicionar query params
