        ...
        <div className={style.linkContent}>
          ...
          >
            <path
              ...
              d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0121 18.382V7.618a1 1 0 01-.806-.984A1 1 0 0021 7.618l-4.553-2.276M15 7v13M9 7l6-3M9 7L3.553 4.276"
            />
          </svg>
          ...
          <span className={style.subText}>Ver trajeto de carro/apé</span>
        </div>
      </a>
    </div>
  );
